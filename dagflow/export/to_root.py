...
from ROOT import TFile, TH1D, TH2D, TGraph, TGraph2D

if TYPE_CHECKING:
    from pathlib import Path

    try:
        from ROOT import TDirectory, TObject, TH1, TH2
    except ImportError:
        pass
...
class ExportToRootVisitor(NestedMKDictVisitor):
    ...
    def __init__(self, filename: Union['Path',str]):
        ...
        logger.log(DEBUG, f"Create {filename}")
    ...
    def stop(self, dct):
        logger.log(DEBUG, f"Close {self._file.GetName()}")
        self._file.Close()
